...
public class BeerController {
    ...
    public ResponseEntity<BeerDto> getBeerById(@PathVariable("beerId") UUID beerId,@RequestParam(value = "showQuantityOnHand",required = false) Boolean showQuantityOnHand){

        if(showQuantityOnHand==null){
            showQuantityOnHand=false;
        }

        return new ResponseEntity<>(beerService.getById(beerId,showQuantityOnHand), HttpStatus.OK);
    }
